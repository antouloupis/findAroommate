...
function validateRoommates(input) {
    ...
    if (value < 1) {
        input.value = 1; // Set minimum
    } else if (value > 10) {
        input.value = 10; // Set maximum
    }
}
...
function validateSize(input) {
    ...
    if (value < 15) {
        input.value = 15; // Set minimum
    } else if (value > 500) {
        input.value = 500; // Set maximum
    }
}
...
function validatePrice() {
    ...
    if (minPrice !== null && maxPrice === null) {
        if (minPrice < 15) {
            minInput.value = 15; // Set minimum allowed value
    ...
    if (minPrice === null && maxPrice !== null) {
        if (maxPrice > 5000) {
            maxInput.value = 5000; // Set maximum allowed value
        } else if (maxPrice < 15){
            maxInput.value = 15;
        }
    }
